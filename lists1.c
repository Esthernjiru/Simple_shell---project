...
/**
 * list_to_strings - this function will return an array of strings of the list->str
...
/**
 * print_list - this function that prints all elements of a list_t linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
